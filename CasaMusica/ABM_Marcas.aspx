<%@ Page Title="" Language="C#" MasterPageFile="~/CasaMusica.Master" AutoEventWireup="true" CodeBehind="ABM_Marcas.aspx.cs" Inherits="CasaMusica.ABM_Marcas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><% = item.Nombre %></td>
                        <td><a class="btn btn-outline-primary" href="MarcaEdit.aspx?ID=<% = item.ID %>">Modificar</a></td>
                        <td><a href="ABM_Marcas.aspx?ID=<% = item.ID %>">
    ...
    <div class="row pt-2">
        <div class="col offset-10">
            <a href="MarcaEdit.aspx" class="btn btn-dark">Agregar Nueva</a>
        </div>
    </div>
    <%--MODALS--%>
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title">
                                    <asp:Label ID="lblModalTitle" runat="server" Text="">Baja Marca</asp:Label>
                                </h4>
                            </div>
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="ABM_Marcas.aspx" class="btn btn-info">Volver</a>
                            </div>
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
